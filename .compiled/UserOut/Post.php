...
class Post extends Foundation\ActorOut\Write {
    ...
    const FEED_SIMPLE_LABEL = "%tail.username% posted %head.username%";
    const FEED_AGGREGATED_LABEL = "%tail.username% posted %head.username%";
 ...
 * Size (in bytes): 1636
 * Compilation Time: 67
 * 24a050c032fff770f085a90ece95b1ce
 ******************************************************/